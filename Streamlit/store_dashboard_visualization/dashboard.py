...
all_df = pd.read_csv("https://raw.githubusercontent.com/ekobw/Data-Science/main/Streamlit/all_data.csv")
...
with st.sidebar:
    ...
    st.image("https://github.com/ekobw/Data-Science/blob/main/Streamlit/eko_logo.png?raw=true")
