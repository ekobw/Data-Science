...
all_df = pd.read_csv("https://raw.githubusercontent.com/ekobw/Data-Science/main/Streamlit/clothing_store_dashboard/all_data.csv")
...
with st.sidebar:
    ...
    st.image("https://github.com/ekobw/Data-Science/blob/main/Streamlit/clothing_store_dashboard/eko_logo.png?raw=true")
...
st.header('Eko Collection Dashboard :shirt:')
